...
class Game:  # Initialize Pygame modules.
    def __init__(self):
        pygame.init()
        pygame.mixer.init()
        ...
        while True:
            ...
            while True:
                ...
                if isinstance(level_result, dict):
                    ...
                    # Update the high score on the final stage.
                    if is_final_stage:
                        best_score_before = (self.score_manager.load_best_score())
                        if attempt_total > best_score_before: self.score_manager.save_best_score(attempt_total)
                ...
                result_screen = LevelResult(self.window, level_result, has_next_stage)
